...
public class General extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                General(country,category,apikey);
            }
        });
    ...
    private void General(String country, String category, String apikey) {
        ...
        call.enqueue(new Callback<Headlines>() {
            ...
            public void onResponse(Call<Headlines> call, Response<Headlines> response) {
                ...
                if (response.isSuccessful() && response.body().getArticles()!=null)
                {
                    ...
                    bap = new busadp(General.this,articles);
            ...
            public void onFailure(Call<Headlines> call, Throwable t) {
                swipeRefreshLayout.setRefreshing(false);
                Toast.makeText(General.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
